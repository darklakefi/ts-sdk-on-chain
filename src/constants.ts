...
// Program IDs
export const DARKLAKE_PROGRAM_ID = new PublicKey(
...
// Fee vaults
export const DEVNET_CREATE_POOL_FEE_VAULT = new PublicKey(
  '6vUjEKC5mkiDMdMhkxV8SYzPQAk39aPKbjGataVnkUss',
);
export const MAINNET_CREATE_POOL_FEE_VAULT = new PublicKey(
...
export const DEVNET_LOOKUP = new PublicKey(
  'fUT5cRYT7RTS4kSq7ZpPwqaH7E68soubbutFxYHeNjo',
);
export const MAINNET_LOOKUP = new PublicKey(
