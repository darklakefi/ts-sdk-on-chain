...
export const getDarklakeAmmSwapAccounts = (
  accounts: DarklakeAmmSwapAccounts,
): Array<AccountMeta> => {
  return [
    {
...
export const getDarklakeAmmSettleAccounts = (
  accounts: DarklakeAmmSettleAccounts,
): Array<AccountMeta> => {
  return [
    {
...
export const getDarklakeAmmCancelAccounts = (
  accounts: DarklakeAmmCancelAccounts,
): Array<AccountMeta> => {
  return [
    {
      pubkey: accounts.caller,
...
export const getDarklakeAmmSlashAccounts = (
  accounts: DarklakeAmmSlashAccounts,
): Array<AccountMeta> => {
  return [
    {
      pubkey: accounts.caller,
...
export const getDarklakeAmmAddLiquidityAccounts = (
  accounts: DarklakeAmmAddLiquidityAccounts,
): Array<AccountMeta> => {
  return [
    {
      pubkey: accounts.user,
...
export const getDarklakeAmmRemoveLiquidityAccounts = (
  accounts: DarklakeAmmRemoveLiquidityAccounts,
): Array<AccountMeta> => {
  return [
    {
      pubkey: accounts.user,
...
export const getDarklakeAmmInitializePoolAccounts = (
  accounts: DarklakeAmmInitializePoolAccounts,
): Array<AccountMeta> => {
  return [
    {
      pubkey: accounts.user,
